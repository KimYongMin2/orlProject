...
<div class="main">
    ...
    <div class="main_map">
        ...
        <button class="mapbutton mapbutton1">전국 산 보기</button>
        <button class="mapbutton mapbutton2">지역별 산 보기</button>
    </div>
