    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <c:forEach items="${memberList}" var="list">
            <tr>
                ...
                <td>
                    <a id="deleteId" href="<c:url value='/admin/member/delete?memberIdx=${list.memberIdx}'/>"
                                ...
                                <div class="modal-body selectList">
                                    <c:forEach items="${feedList}" var="fList">
                                        <c:if test="${list.memberIdx eq fList.memberIdx}">
                                            <div class="item">
                                                <img alt="gggg" class="img"
                                                     src="<c:url value='/images/feed/feedw/uploadfile/${fList.boardPhoto}'/>"
                                                     width="80px" height="80px">
                                                <span># ${list.memberIdx}</span>
                                            </div>
                                        </c:if>
                                    </c:forEach>
                                </div>
